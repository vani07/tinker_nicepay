...
define("NICEPAY_IMID",              Mage::getConfig()->getNode('default/payment/virtualaccount')->nicepay_mid);                                                  // Merchant ID
define("NICEPAY_MERCHANT_KEY",      Mage::getConfig()->getNode('default/payment/virtualaccount')->nicepay_key); // API Key
